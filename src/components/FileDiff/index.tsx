...
export const FileDiff = () => {
  ...
  return (
    <div
      className={cn(
        'pointer-events-none invisible opacity-0 transition-all translate-x-4 absolute inset-0 left-4 bg-surface rounded-md',
    ...
    >
      ...
      {selectedFile && (
        <>
          <div className="pl-3 pr-1 h-10 border-b border-foreground/20 flex items-center">
            <FileName
